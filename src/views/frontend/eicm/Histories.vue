  ...
  <v-container grid-list-xs>
    <v-row wrap>
      <v-col>
        <v-card flat>
          <v-card-title primary-title>
            <h4 class="font-weight-light text-uppercase primary--text">História</h4>
            <v-spacer></v-spacer>
          ...
          <v-divider></v-divider>
          <v-card-text>
            <p class="text-justify">{{history.content}}</p>
          </v-card-text>
        </v-card>
      </v-col>
      ...
      <v-col cols="12">
        <v-card flat>
          <v-card-title primary-title>
            <h4 class="font-weight-light text-uppercase primary--text">Marcos Históricos</h4>
            <v-spacer></v-spacer>
            <v-btn color="grey" icon>
              <v-icon>mdi-share</v-icon>
            </v-btn>
          ...
          <v-card-text>
            <v-timeline>
              <template v-for="(mark, index) in history.marks">
                <v-timeline-item small :key="index">
                  <span
                    slot="opposite"
                    :class="`headline font-weight-bold`"
                  >{{mark.begin}} - {{mark.end}}</span>
                  <div class="py-3">
                    <h2 :class="`headline font-weight-light mb-3`">{{mark.title}}</h2>
