// jshint esversion:6
import { getAuthLocalUser } from '@/helpers/auth';
...
export default ({
    ...
    mutations: {
        ...
        login(state) { state.loading = true; state.auth_error = null; },
        ...
        loginFailed(state, payload) { state.loading = false; state.auth_error = payload.error; },
    ...
    actions: { login(context) { context.commit("login"); }, },
